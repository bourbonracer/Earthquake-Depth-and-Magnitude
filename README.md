...
#### Import & Visualize the Data
   ...
   * Data markers should reflect the magnitude of the earthquake by their size and and depth of the earth quake (Note: the depth of the earth can be found as the third coordinate for each earthquake)  by color. Earthquakes with higher magnitudes should appear larger and earthquakes with greater depth should appear darker in color.
